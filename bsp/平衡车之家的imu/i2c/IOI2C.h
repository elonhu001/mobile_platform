...
#define GPIOH_ODR_Addr    (GPIOH_BASE+20) //0x40011A0C    
#define GPIOI_ODR_Addr    (GPIOI_BASE+20) //0x40011E0C  
...
#define GPIOH_IDR_Addr    (GPIOH_BASE+16) //0x40011A08 
#define GPIOI_IDR_Addr    (GPIOI_BASE+16) //0x40011E08 
...
//IO方向设置
#define SDA_IN()  {GPIOF->MODER&=~(3<<(9*2));GPIOB->MODER|=0<<9*2;}	//PF9输入模式
#define SDA_OUT() {GPIOF->MODER&=~(3<<(9*2));GPIOB->MODER|=1<<9*2;} //PF9输出模式
